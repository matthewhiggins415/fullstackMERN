...
//@desc     Get current users profile, just get ours.
//@access   Private
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      //if no profile is found let's create a new one.
...
router.delete("/", auth, async (req, res) => {
  try {
    //TO DO - remove users posts, gotta do it before u delete the user
